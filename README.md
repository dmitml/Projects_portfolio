...
Всего выполнено более 25 проектов, в т.ч.: 2 pet-проектa, 8 проектов по классическим методам машинного обучения, 3 проекта в области обработки естественного языка, 4 проекта по компьютерному зрению и нейросетевым моделям.    
...
18. (kaggle) Детекция сгенерированных текстов (6-е место на kaggle)
19. (Pet-проект) Модуль деанонимизации медицинских эпикризов
