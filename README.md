...
Всего выполнено 18 проектов, в т.ч.: 1 pet-проект, 8 проектов по классическим методам машинного обучения, 3 проекта в области обработки естественного языка, 4 проекта по компьютерному зрению и нейросетевым моделям.    
