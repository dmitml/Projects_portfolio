# Обработка и деанонимизация эпикризов
...
Приложение для обработки и деанонимизации данных из выписных эпикризов. Вся обработка выполняется на сервисе Yandex Cloud.
